        ...
        <div class="bg-white rounded-lg shadow-lg p-6 lg:p-8 w-full max-w-md">
          <div class="space-y-6">
            ...
            <form class="space-y-4 mt-6" @submit.prevent="handleSignUp">
              ...
              <div class="flex justify-center items-center bg-blue-600 p-3 rounded-md text-white mt-4 mb-4 hover:bg-blue-700">
                <button 
                  type="submit" 
            ...
            <p class="text-center text-[11px]">
              ...
              to our <a href="" class="text-blue-500">Terms of use</a> and <a href="" class="text-blue-500">Privacy Policy</a>
            </p>
          </div>
        </div>
      </div>
