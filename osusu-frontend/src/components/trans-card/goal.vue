<template>
    <div class="bg-white rounded-xl shadow-md p-6 m-6">
        ...
        <div class="flex flex-col md:flex-row md:justify-between md:items-center mb-6 space-y-4 md:space-y-0">
            ...
            <h1>
                <select class="w-full md:w-auto border border-gray-300 rounded-lg px-4 py-2 focus:outline-none focus:ring-2 focus:ring-primary-500 focus:border-transparent">
            ...
            <div v-for="value in source" :key="value.goal">
                <div class="border border-gray-200 rounded-xl p-5 hover:shadow-md transition-all w-full">
                    <div class="flex justify-between">
                        ...
                        <div :class="value.col">
                            <p class="bg-blue-100 text-xs font-medium px-2 py-1 rounded capitalize">{{ value.active ? 'active' : 'completed'}}</p>
                        </div>
                    </div>
                    ...
                    <div class="mb-4">
                        <progress class="progress w-full" :class="value.active ? 'progress-primary' : 'progress-[gray]'" :value="value.progress" max="100"></progress>
                    </div>
                ...
                <form @submit.prevent="submitGoal">
                    <div class="space-y-4">
                        ...
                        <div>
                            ...
                            <textarea 
                                id="goalReason" 
                                v-model="newGoal.reason" 
                                rows="3"
                                class="w-full border border-gray-300 rounded-lg px-4 py-2 focus:outline-none focus:ring-2 focus:ring-primary-500 focus:border-transparent"
                                placeholder="Describe why you're saving for this goal"
                                required
                            ></textarea>
                        </div>
                        ...
                        <!-- Monthly Save -->
                        <div>
                            <label for="monthlySave" class="block text-sm font-medium text-gray-700 mb-1">Monthly Save (₦)</label>
                            <input 
                                type="number" 
                                id="monthlySave" 
                                v-model="newGoal.monthlySave" 
                                min="0"
                                class="w-full border border-gray-300 rounded-lg px-4 py-2 focus:outline-none focus:ring-2 focus:ring-primary-500 focus:border-transparent"
                                placeholder="0"
                                required
                    ...
                    <div class="flex justify-end space-x-3 mt-6 pt-4 border-t border-gray-200">
                        ...
                        <button 
                            type="submit" 
                            class="px-4 py-2 bg-[#2563eb] text-white rounded-lg font-medium hover:bg-primary-700 transition-colors"
                        >
                            Create Goal
                        </button>
                    </div>
